...
static void mock_renderable_present(FlRenderable* renderable,
...
static void mock_renderable_iface_init(FlRenderableInterface* iface) {
  iface->present = mock_renderable_present;
...
size_t fl_mock_renderable_get_present_count(FlMockRenderable* self) {
